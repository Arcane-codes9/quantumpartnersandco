...
import { Bell, Moon, Sun, Globe, ChevronDown, Monitor, CheckCircle, XCircle } from 'lucide-react';
...
export function TopNavbar() {
  ...
  const notifications = useMemo(() => Array.isArray(activities?.data?.notifications) ? activities?.data.notifications : [], [user]);
